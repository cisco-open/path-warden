...
func (ctx *httpHeaders) httpCallRequestCallback(numHeaders, bodySize, numTrailers int) {
	// Get Validation Service Response Body
	...
	// If we couldn't retrieve the label from cache OR
